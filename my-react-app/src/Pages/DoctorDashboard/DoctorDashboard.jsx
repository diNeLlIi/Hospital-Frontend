...
const appointmentsData = {
  1: [], 2: [], 3: [], 4: [], 5: [], 6: [],
  7: ['2PM-4PM'],
  8: [], 9: ['9AM-1PM'], 10: ['6PM-11PM'],
  11: [], 12: ['2PM-7PM'], 13: ['9AM-3PM'],
  14: ['9AM-12PM'], 15: [],
  16: ['6PM-10PM'],
  17: [], 18: ['6AM-10PM'], 19: ['10AM-3PM'],
  20: ['12PM-4PM'], 21: [], 22: [], 23: [], 24: [],
  25: [], 26: ['1PM-2PM'], 27: [], 28: [], 29: [], 30: [], 31: [],
};
...
const DoctorDashboard = () => {
  ...
  const handleDateClick = (selectedDate) => {
    ...
    if (selectedDate.getDate() === 16) {
      navigate('/doctor-date-selection');
    }
  };
      ...
      <div className="dashboard-scroll-container">
        ...
        <div className="dashboard-section">
          <h2 className="section-title">
            Today - 07th August 2025 - Dr. Nimal Perera
          </h2>
